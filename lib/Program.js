  ...
  Program = (function() {
    ...
    function Program(options) {
      ...
      if ((_ref2 = (_base2 = this.options).usage) == null) {
        _base2.usage = ["  Usage: salut-c-est-alfred-ton-banquier-generator [options] method [arguments...]", "", "    Options:", "", "       -v, --verbose        verbose", "       -o, --out <file>     output file", "       -V, --voice <voice>  voice", "", "    Commands:", "", "       list-voices", "       list-words", "       say <word1> <word2> <...>", "       say-random <length>", ""];
      }
