...
(function() {
  ...
  Alfred = (function() {
    ...
    Alfred.prototype.sayAlfredPass = function(length, fn) {
      var chars, destFile, i, passphrase, words, _i,
        _this = this;
      if (length == null) {
        length = 42;
      }
      ...
      words.push('voila');
      passphrase = words.slice(1, words.length - 1).join('-');
      destFile = this.getDestFile("alfred_" + passphrase + ".mp3");
      return this.saveSayList(words, destFile, function(err, data) {
        system('play', [destFile]);
        return console.log(passphrase);
      });
    };
